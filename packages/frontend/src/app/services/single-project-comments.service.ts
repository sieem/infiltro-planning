...
import { BehaviorSubject, firstValueFrom, Observable, shareReplay, switchMap, combineLatest, of } from 'rxjs';
...
export class SingleProjectCommentsService {
  ...
  addComment() {
    ...
    formData.append('user', this.commentForm.value.user as string)
    ...
    formData.append('content', this.commentForm.value.content as string)
  ...
  editComment(comment: IComment) {
    ...
    this.commentForm.setValue({
      ...
      user: comment.user || "",
      createdDateTime: comment.createdDateTime as any,
      modifiedDateTime: comment.modifiedDateTime as any
    })
  }
